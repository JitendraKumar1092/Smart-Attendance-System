...
def update_csv_logout(name):
    if name in known_face_names and attendance_time[name] is not None:
        current_time = datetime.now()
        lnwriter.writerow([name, attendance_time[name].strftime("%H:%M:%S"), current_time.strftime("%H:%M:%S")])
